...
public class Addition
{
	...
	[TestMethod]
	public void Add_Invalid_Hawkins()
	{
...
{
    [TestMethod]
    public void Subtract_Valid_Hawkins()
    {
    ...
    [TestMethod]
    public void Subtract_Invalid_Hawkins()
    {
    ...
    [TestMethod]
    public void Subtract_Null_Hawkins()
    {
...
{
    [TestMethod]
    public void Multiply_Valid_Hawkins()
    {
    ...
    [TestMethod]
    public void Multiply_Invalid_Hawkins()
    {
    ...
    [TestMethod]
    public void Multiply_Null_Hawkins()
    {
...
{
    [TestMethod]
    public void Divide_Valid_Hawkins()
    {
        Assert.AreEqual(3, Program.Divide("6", "2"));
        Assert.AreEqual(-4, Program.Divide("-12", "3"));
        Assert.AreEqual(15, Program.Divide("-45", "-3"));
    }

    [TestMethod]
    public void Divide_Invalid_Hawkins()
    {
    ...
    [TestMethod]
    public void Divide_Null_Hawkins()
    {
...
public class Power
{
    ...
    [TestMethod]
    public void Power_Invalid_Hawkins()
    {
    ...
    [TestMethod]
    public void Power_Null_Hawkins()
    {
